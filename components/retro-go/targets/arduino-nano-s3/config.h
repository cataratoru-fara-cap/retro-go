...
#define RG_SCREEN_DRIVER            0  // 0 = ILI9341, 1 = ST7735S
...
// ST7735S Green Tab Specific Init
// Note: Assumes your driver uses ILI9341_CMD or a compatible macro.
// If st7735s.h uses a different command macro, this will need to be adjusted.
...
#define RG_GAMEPAD_ADC_MAP {\
    {RG_KEY_UP,    ADC_UNIT_1, ADC_CHANNEL_0, ADC_ATTEN_DB_11, 4095, 4096},\
    {RG_KEY_DOWN,  ADC_UNIT_1, ADC_CHANNEL_0, ADC_ATTEN_DB_11, 4095, 4096},\
    {RG_KEY_RIGHT, ADC_UNIT_1, ADC_CHANNEL_1, ADC_ATTEN_DB_11, 4095, 4096},\
    {RG_KEY_LEFT,  ADC_UNIT_1, ADC_CHANNEL_1, ADC_ATTEN_DB_11, 4095, 4095},\
}
